...
def get_driving_status(vehicle_actor, image):
    ...
    # velocity
    image = cv2.putText(image, f"velocity: {absolute_velocity*18/5} km/h", (900, 660), GLOBAL_FONT, custom_fontscale, custom_color, custom_thickness)
...
def spawn_camera(camera_blueprint, camera_spawnpoint):
    ...
    camera_blueprint.set_attribute("sensor_tick", "0.5")  # capture image every 0.3 seconds
